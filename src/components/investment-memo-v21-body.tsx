    ...
    <>
      ...
      <section id="operations" className={sectionClass}>
        ...
        <Prose>
          ...
          <p>Tether Referrals is in production. Variable cost per AI-generated referral is approximately $0.004 per invocation at launch scope. Gross margin on every subscription is effectively the full subscription price at launch scope.</p>
        ...
        <Prose>
          <ol className="m-0 list-decimal space-y-2 pl-5">
            ...
            <li>Request the CMF 2026 exhibitor prospectus and confirm the table once the founder tranche lands (payments are non-refundable).</li>
      ...
      <section id="capital" className={sectionClass}>
        ...
        <Prose>
          ...
          <p><span className="font-semibold">Product expansion to the full platform (approximately $30K-$50K).</span> Stedi production-scale eligibility (~$15K-$25K), Vapi voice at GA scale (~$15K-$25K), and the second engineering hire who takes Tether Eligibility and Tether Voice from design-partner alpha to general availability and ships the multi-EHR adapters. This is the bridge from $600 launch pricing to $1,200 full-platform pricing, and from $15K-$20K early ACV toward $15K-$30K mature blended ACV as network contracts enter the mix.</p>
          ...
          <p><span className="font-semibold">Second engineer (approximately $180K annual including equity).</span> Takes Tether Eligibility and Tether Voice from design-partner alpha to general availability, then leads multi-EHR work. Frees Ravi to focus on runtime substrate and core platform.</p>
